...
# Same for a GitHub advisory ID — useful when there is no CVE (ghsas/ is one unsharded file)
jq '."GHSA-2whq-6rcm-64m8"' index/oss-security/ghsas/all.json
...
curl -s https://raw.githubusercontent.com/joemalcolm/oss-security-archive/main/index/oss-security/manifest.json | jq '{generated_at, total_messages, total_cves, total_ghsas}'
